...
local defaults = {
        ...
        types = { fg = c.white, bold = true, italic = true },
        values = { fg = c.white },
        functions = { fg = c.white, underline = true },
        operators = { fg = c.white },
        keywords = { fg = c.white, italic = true, bold = true },
        strings = { fg = c.white },
        const = { fg = c.white, bold = true },
...
vim.api.nvim_set_hl(0, "Constant", defaults.const)    -- Constantes generales.
...
vim.api.nvim_set_hl(0, "@method", defaults.functions)            -- Métodos de objetos.
...
vim.api.nvim_set_hl(0, "@variable", defaults.variables)          -- Variables.
vim.api.nvim_set_hl(0, "@constant", defaults.const)              -- Constantes.
